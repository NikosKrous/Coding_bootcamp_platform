                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="company_profile_info">
                                        <div class="company-up-info">
                                            ...
                                            <h4>${student.title}</h4>
                                            <ul>
                                                <li><a href="${pageContext.request.contextPath}/admin/deleteStudent.htm?studid=${student.id}" title="" class="message-us">Delete</a></li>
                                            </ul>
                                        </div>
                                        <a href="${pageContext.request.contextPath}/admin/viewProfile.htm?studid=${student.id}" title="" class="view-more-pro">View Profile</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
