                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="company_profile_info">
                                        <div class="company-up-info">
                                            <img src="/images/${teacher.profilepic}" height="90" width="90" lt="">
                                            <h3>${teacher.username}</h3>
                                            <h4>${teacher.streamId.stream}</h4>
                                            <ul>
                                                <li><a href="${pageContext.request.contextPath}/student/createEmptyMessageForTeacher.htm?teachid=${teacher.id}" title="" class="follow"><i class="fa fa-envelope"></i></a></li>
                                            </ul>
                                        </div>
