                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="company_profile_info">
                                        <div class="company-up-info">
                                            ...
                                            <ul>
                                                <li><a href="${pageContext.request.contextPath}/admin/deleteCompany.htm?comid=${company.id}" title="" class="message-us">Delete</a></li>
                                            </ul>
                                        </div>
                                        <a href="${pageContext.request.contextPath}/admin/viewProfileCompany.htm?comid=${company.id}" title="" class="view-more-pro">View Profile</a>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
